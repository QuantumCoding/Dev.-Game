...
public class ParticleEmitterNon {
	...
	public ParticleEmitterNon(ParticleManager manager, Vector3f position, ParticleTexture texture, float emitionDelay, boolean other) {
		...
		while(elapsedTime >= emitionDelay) {
			...
			if(Keyboard.isKeyDown(Keyboard.KEY_P)) {
				...
				Particle particle = new Particle(position, (float) (Math.random() * 360), new Vector3f(1),//0.25f), 
						...
						new Vector3f(0, -15, 0), 2f, texture);
				manager.addParticle(particle);
			}
