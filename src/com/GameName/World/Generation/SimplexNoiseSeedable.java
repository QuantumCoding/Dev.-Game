...
public class SimplexNoiseSeedable {
...
//	};
	...
	public SimplexNoiseSeedable(long SEED) {
		Random rand = new Random(SEED);
		p = new short[256];
		
		for(int i = 0; i < p.length; i ++) {
			p[i] = (short) (rand.nextDouble() * 255);
		}
	...
	public double noise(double xin,  double yin,  double zin) {
		...
		if(x0>=y0) {
			if(y0>=z0) { 
				...
				i1=1; j1=0; k1=0; i2=1; j2=0; k2=1;  // X Y Z order
			} else { 
				i1=0; j1=0; k1=1; i2=1; j2=0; k2=1;  // X Y Z order
			}
